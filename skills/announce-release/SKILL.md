...
- `github_connected` is true and `tracked_repositories` covers the repo the
  user shipped from. If not, stop and send them to the Shipstar dashboard
  (Sources → GitHub) — you cannot connect repos over MCP.
